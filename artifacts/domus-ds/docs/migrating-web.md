# Migrating web UI to Domus Design System

Read `artifacts/domus-ds/docs/AGENTS.md` and
`artifacts/domus-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/domus-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/domus-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/domus-ds/hooks/use-toast`
