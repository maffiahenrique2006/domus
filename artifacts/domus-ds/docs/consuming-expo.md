# Consuming Domus Design System in Expo apps

Read `artifacts/domus-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/domus-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/domus-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/domus-ds/lib/native-theme";
import { useColors } from "@workspace/domus-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/domus-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/domus-ds/components/native/badge";
import { Button } from "@workspace/domus-ds/components/native/button";
import { Card } from "@workspace/domus-ds/components/native/card";
```
...
Import and render
`@workspace/domus-ds/components/native/button`, then run Expo
